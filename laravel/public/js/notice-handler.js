...
document.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  var menusContainer, addMenuBtn, submitButton, fetchMenus, _fetchMenus, addMenuSelect, _addMenuSelect;
    ...
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        ...
        _fetchMenus = function _fetchMenus3() {
          _fetchMenus = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var response;
